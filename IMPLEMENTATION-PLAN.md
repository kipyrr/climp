...
**The watcher is not gated.** `backfill_since` applies to the reconciler only. A clip recorded *now* arrives as an event and must be uploaded regardless of what any timestamp says.
